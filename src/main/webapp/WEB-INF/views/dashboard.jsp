...
<div class="container mt-4 text-center">
    ...
    <div class="row justify-content-center mt-4">
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <a href="view-students" class="btn btn-primary mt-2">View Students</a>
            </div>
        </div>
    ...
    <!-- BUTTONS -->
    <div class="mt-4">
        <a href="add-student" class="btn btn-primary me-3">
    ...
    <div class="row mt-5 text-start">
        ...
        <%
        	List<String> students =(List<String>) request.getAttribute("recentStudents");
        %>
            ...
            <div class="card">
                <h6>Recent Students</h6>
                	...
                	%>
                        ...
                        <div class="item"><i class="fa-solid fa-user me-2"></i><%=sname%></div>
                    <%
                		}
                    %>
        ...
        <!-- COURSES -->
        <%
        	List<String> rcn =(List<String>) request.getAttribute("recentCourses");
        %>
        <div class="col-md-6">
            <div class="card">
                <h6>Recent Courses</h6>
                        ...
                        <%
                        	for(String cname : rcn){
                        %>
						<div class="item"><i class="fa-solid fa-book me-2"></i><%=cname%></div>
						<%
                        	}
						%>
            </div>
